...
MUTATIONS = [
    ...
    ("serve: the control socket replaces whatever file is in its way",
     "serve/control.go",
     "		if info.Mode()&os.ModeSocket == 0 {",
     "		if false && info.Mode()&os.ModeSocket == 0 {"),
    ("serve: php-fpm's whole rejection is published with the history",
     "serve/history.go",
    ...
    ("serve: a blocked apply publishes nothing",
     "serve/serve.go", "		l.setApplyBlocked(\"no_master\")", "		l.setApplyBlocked(\"\")"),
